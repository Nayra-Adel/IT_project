...
$rows = $db->query($sql);
 ...
 <html lang="en">
    ...
    <div class="panel-heading header">
        ...
        <form class="pull-right" action="login.php" onsubmit="changeSession()">
 ...
 while($row = $rows->fetch_assoc()){
   ...
   echo "<div class='panel-body'><img src='".$row['img']."' class='img-responsive' alt='Image' style='  width:100%;height: 500px;'></div>";
